...
mixin _$LoginRequestModel {
  ...
  @override
  String toString() {
    return 'LoginRequestModel(firstName: $firstName, lastName: $lastName)';
  }
}
...
extension LoginRequestModelPatterns on LoginRequestModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String firstName, String lastName)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _LoginRequestModel extends LoginRequestModel {
  const _LoginRequestModel({required this.firstName, required this.lastName})
      : super._();
